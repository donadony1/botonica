      ...
      <div className="bg-[#f9f9f9] w-full max-w-lg rounded-3xl p-6 sm:p-8 shadow-2xl border border-[#c4c8c0]/40 max-h-[90vh] overflow-y-auto">
        {step === 'form' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[#c4c8c0] rounded-xl px-4 py-2.5 text-sm text-[#1a1c1c] focus:outline-none focus:border-[#4f614e]"
                />
              </div>
              ...
              <div>
                <label className="block text-xs uppercase tracking-wider font-semibold text-[#434842] mb-1.5 flex justify-between items-center">
                  ...
                  <span className="material-symbols-outlined text-[18px] text-[#4f614e]">lock</span>
                </label>
                <input
                  required
                  type="text"
              ...
              <div className="pt-4 border-t border-[#c4c8c0]/30 flex flex-col gap-3">
                <button
                  ...
                  className="w-full bg-[#4f614e] text-white py-4 rounded-full text-xs font-semibold uppercase tracking-[0.2em] hover:bg-[#3a4b39] transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {isSubmitting ? (
          ...
          <div className="text-center py-6">
            <div className="w-16 h-16 bg-[#d4e8d0] rounded-full flex items-center justify-center mx-auto mb-6 text-[#4f614e]">
              <span className="material-symbols-outlined text-3xl">check</span>
            </div>
            <span className="text-xs uppercase tracking-[0.2em] text-[#824f39] font-bold block mb-2">
              Commande Confirmée #BOT-2024
            </span>
            <h3 className="font-serif-luxury text-3xl text-[#4f614e] mb-4">
            ...
            <div className="bg-white p-4 rounded-2xl border border-[#c4c8c0]/30 text-xs text-[#434842] mb-8 space-y-1 text-left">
              ...
              <div className="flex justify-between font-serif text-sm pt-2 border-t border-[#f3f3f4] text-[#4f614e]">
            ...
            <button
              ...
              className="w-full bg-[#4f614e] text-white py-3.5 rounded-full text-xs font-semibold uppercase tracking-wider hover:bg-[#3a4b39] transition-colors"
            >
