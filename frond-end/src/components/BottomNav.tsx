    ...
    >
      <div className="flex justify-around items-center h-20 pb-safe px-4 max-w-md mx-auto">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center px-3 py-1 text-xs tracking-wider transition-all duration-200 cursor-pointer ${
            currentScreen === 'home'
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center px-3 py-1 text-xs tracking-wider transition-all duration-200 relative cursor-pointer ${
            currentScreen === 'cart'
              ? 'text-[#bb0a4a] font-bold bg-[#d4e8d0]/40 rounded-xl'
              : 'text-[#434842] hover:text-[#bb0a4a] active:scale-95'
          }`}
