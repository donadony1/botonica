...
export default function ArticleFormModal({ article, allProducts, onClose }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const savedArticle: Article = {
      ...
      author: form.author.trim() || 'Karene Bella',
      authorRole: form.authorRole.trim() || 'Fondatrice & Formulatrice Botanique',
      authorAvatar: form.authorAvatar.trim() || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
      publishedAt: form.publishedAt.trim() || new Date().toLocaleDateString('fr-FR'),
      readTime: form.readTime.trim() || '4 min de lecture',
      readTimeEn: form.readTimeEn.trim() || '4 min read',
