...
export default function ProductFormModal({ product, onClose }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const saved: Product = {
      ...
      taglineEn: form.taglineEn.trim() || undefined,
      ...
      longDescriptionEn: form.longDescriptionEn.trim() || undefined,
      ...
      inci: form.inci.trim() || 'Composition 100% naturelle.',
      originCountry: form.originCountry.trim() || 'France / Provence',
      responsiblePerson: form.responsiblePerson.trim() || 'Ndolo Rituals SARL',
      batchNumber: form.batchNumber.trim() || undefined,
      pao: form.pao.trim() || '18M',
    };
